document.addEventListener('DOMContentLoaded', () => {
    ...
    previewButton.addEventListener('click', async () => {
        ...
        const previewResponse = await fetch('/get-estimate', {
            method: 'POST',
            body: formData
        });
        ...
        displayResults(previewResult, true);
    });
    ...
    function updateEstimate() {
        ...
        document.getElementById('estimate-result').innerHTML = estimateResult;
    ...
    function displayResults(result, isPreview = false) {
        ...
        if (isPreview) {
            ...
            document.getElementById('estimate-result').appendChild(previewImage);
            ...
            document.getElementById('estimate-result').appendChild(downloadLinkPdf);
        }
    }
});
